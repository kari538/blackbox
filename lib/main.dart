...
import 'local_notifications.dart'; //xxx
import 'fcm.dart';
...
//This seems to be working!
  ...
  LocalNotifications.initiate(); //xxx
...
class Blackbox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
    // Commented out the ChangNotifierProvider:
      ChangeNotifierProvider<GameHubUpdates>(
      create: (_) {
...
//        home: WelcomeScreen(),
        home: AnnotatedRegion<SystemUiOverlayStyle>(
          // child: MyHomePage(title: 'Testing main'), // Found at bottom of page, for testing
          child: WelcomeScreen(),
