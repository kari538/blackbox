...
class GameEntry extends StatelessWidget {
  ...
  List<Widget> getLeftSideChildren(BuildContext context) {
    ...
    // final String senderScreenName = setup.get(kFieldSender) == myId && userIdMap[setup.get(kFieldSender)] == 'Anonymous'
    //     ? "Me"
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          Expanded(
            child: RightSideChildren(setup: setup, setupData: setupData, i: i),
          ),
        ],
      ),
    );
...
class RightSideChildren extends StatefulWidget {
  const RightSideChildren({@required this.setup, @required this.setupData, @required this.i});
            ...
            GestureDetector(
              ...
              onTap: () {
                currentSetupData['results'].containsKey(me) ||
                        ...
                        currentSetupData[kFieldSender] == myEmail ||
